...
public class SymbolTable{
    ...
    private static LinkedHashMap<String,LinkedHashMap<String,String[]>> table;
    ...
    public void updateTemp(String scope, String name, String type){
	String[] temp = {type,null};
	table.get(scope).put(name,temp);	
    }
